...
export interface LuckyCoinWheelProps {
...
function LuckyCoinWheelComponent(
  { childrenWidth, multipliers /**, children */, background, onSpinEnd }: LuckyCoinWheelProps,
  ref: Ref<LuckyCoinWheelHandler>
) {
...
export const LuckyCoinWheel = forwardRef(LuckyCoinWheelComponent);
